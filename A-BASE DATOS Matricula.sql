Create Database BDMatricula ON PRIMARY  

(
name = BDMatricula_data,
filename = 'D:\UNIVERSIDAD\SEMINARIO I\Producto Final\BDMatricula\BDMatricula.mdf',       
size = 1 gb,                                                    
maxsize = 10gb,                                                 
filegrowth = 2mb                                               
)
log on
(
name = BDMatricula_log,
filename = 'D:\UNIVERSIDAD\SEMINARIO I\Producto Final\BDMatricula\BDMatricula.ldf',          
size = 1 gb,                                                     
maxsize = 10gb,                                                  
filegrowth = 2 mb 
)
